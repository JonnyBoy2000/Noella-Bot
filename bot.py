...
#from cogs.configs.config       import embed_color, embed_color_succes, embed_color_error, embed_color_attention

import config
import asyncpg

log = logging.getLogger(__name__)
initial_extensions = ('cogs.config', 'cogs.errorhandler', 'cogs.meta', 'cogs.reactions', 'cogs.search', 'cogs.utility', 'cogs.admin', 'cogs.owner', 'cogs.mod', 'cogs.stats', 'cogs.help', 'cogs.kawaii', 'cogs.core', 'cogs.fun', 'cogs.polls', 'cogs.music')
...
class NoellaBot(commands.AutoShardedBot):
    def __init__(self):
        super().__init__(command_prefix=_prefix_callable, pm_help=None, help_attrs=dict(hidden=True))
